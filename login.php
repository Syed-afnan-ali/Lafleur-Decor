        ...
        <div class="container border-5 ">
          <div class="row d-flex justify-content-center">
            <div class=" col-sm-5 border border-5  p-5 border-pink " style="background-color: rgba(0, 0, 0, 0.253);">
              ...
              <h4 class="pt-5 ">Login Your Flower account</h4>
              <form action="" method="post" class="pt-5 border-top">
                ...
                <div class="d-flex">
                  <input type="checkbox">
                  <p class="mt-3 px-2">Confirm your Password</p>
                </div>
                <input type="submit" class="login btn btn-outline-danger w-100" value="Login ">
