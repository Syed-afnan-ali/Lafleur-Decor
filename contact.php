          ...
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse " id="navbarSupportedContent">
              <ul class="navbar-nav me-auto mb-2 mb-lg-0 ">
                ...
                <li class="nav-item">
                  <a class="anchor nav-link active text-danger " aria-current="page" href="./contact.php">Contact</a>
                </li>
                <li class="nav-item dropdown">
...
<div class="container-fluid bg-white px-0">
    <img class="mt-4 " style="width: 100%; height: 30vh;" src="./img/contac.avif" alt="">
    <div class="container" style="border-bottom: 2px solid;">
        <div class="row">
            <div class="col-sm-8 py-5 my-5 px-5 ">
                <h4>CONTACT US</h4>
              <form action="contact_process.php" method="post">
    <label class="pt-3">Subject <span class="text-danger">*</span></label>
    <input name="subject" class="px-3 w-100 py-1 text-secondary border" type="text" placeholder="Customer Service" required>

    <label class="pt-3">Email address <span class="text-danger">*</span></label>
    <input name="email" class="px-3 w-100 py-1 text-secondary border" type="email" placeholder="Your@email.com" required>

    <label class="pt-3">Phone Number <span class="text-danger">*</span></label>
    <input name="phone" class="px-3 w-100 py-1 text-secondary border" type="tel" placeholder="03XXXXXXXXX" required>

    <label class="pt-3">Message <span class="text-secondary">(Optional)</span></label>
    <textarea name="message" class="px-3 w-100 pt-3 pb-3 text-secondary border" style="width: 70%;" placeholder="How can we help?"></textarea>
  ...
  <input type="submit" name="submit" value="SEND" class="btn btn-danger">
            ...
            <div class="col-sm-4 py-5 my-5">
                <h4>INFORMATION</h4>
                <p class="py-3 text-secondary">For any feedbacks or improvements on our online store, please fill in this contact form. We will take a look and reply you within 24 hours. We always need your feedbacks to continuously leverage your shopping experience. We always need your feedbacks to continuously leverage your shopping experience.</p>
                <p class="text-secondary">0304-0810195</p>
                <p class="text-secondary">syeafnanali@gmail.com</p>
                
                <p class="text-secondary">lafleur Decor <br> Gulistan-e-johar Apptech karachi Pakistan Lorem ipsum dolor sit a</p>
            </div>
        </div>
    </div>
    <div class="py-5">
        <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d14473.67025961464!2d67.1433556692505!3d24.91784115365213!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3eb339399c50180f%3A0x676f3b86ff34e073!2sNew%20Wisdom%20Grammar%20School!5e0!3m2!1sen!2s!4v1690061666153!5m2!1sen!2s" width="100%" height="400" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe></div>
        <!-- Worldwide shipping -->
