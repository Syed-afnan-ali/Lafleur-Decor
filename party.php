...
<html lang="en">
    <head>
        ...
        <title>LA'FLEUR DECOR/Party Flower</title>
...
<nav>
  ...
  <?php endif; ?>
              ...
              <ul class="navbar-nav me-auto mb-2 mb-lg-0 ">
                ...
                <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li><a class="dropdown-item active text-danger" href="./party.php">Party Flowers</a></li>
   ...
   <div class="about">
    <div class="container-fluid ">
      <div class="us">
        <h1 class="us2 border-bottom text-center">Party Flower</h1>
      </div>
    </div>
</div>
<!-- about us write -->
