...
<html lang="en">
    <head>
        ...
        <title>LA'FLEUR DECOR/Valentine Spacial</title>
...
<nav>
  ...
  <?php endif; ?>
              ...
              <ul class="navbar-nav me-auto mb-2 mb-lg-0 ">
                ...
                <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li><a class="dropdown-item active text-danger" href="./valentine.php">Valentine Flowers</a></li>
                    <li><a class="dropdown-item " href="./flowers.php">Flowers Day</a></li>
    ...
    <div class="sign0 container-fluid  pt-5" style="background-color: rgba(231, 220, 229, 0.548); z-index: 2;">
   ...
   <div class="about">
    <div class="container-fluid ">
      <div class="us">
        <h1 class="us2 border-bottom text-center"><span class="val"> Valentine Flower</span></h1>
      </div>
    </div>
</div>
<!-- about us write -->
...
<div class="container py-5">
    ...
    <div class="row border d-flex justify-content-between">
       ...
       <a href=""> <img style="width: 5%; cursor: pointer;"  src="./img/download.jpg" alt="" srcset=""></a>
       <a href=""> <img style="width: 5%; cursor: pointer;"  src="./img/download2.png" alt="" srcset=""></a>
    </div>
      ...
      <swiper-container class="mySwiper pb-5" init="false">
        ...
        <swiper-slide >
          <div class=" border border-2 mb-5 w-100 ">
            <img src="./img/val13.webp" alt="" srcset="">
          ...
          <div class=" border border-2 mb-5 w-100 ">
            <img src="./img/val14.webp" alt="" srcset="">
            <div class="bg-white d-flex justify-content-between px-3 pt-3 ">
              <div>
                <span class="fa fa-star checked" style="color: orange; font-size: 13px;"></span>
                <span class="fa fa-star checked" style="color: orange; font-size: 13px;"></span>
          ...
          <div class=" border border-2 mb-5 w-100 ">
            <img src="./img/val15.webp" alt="" srcset="">
            <div class="bg-white d-flex justify-content-between px-3 pt-3 ">
              <div>
                <span class="fa fa-star checked" style="color: orange; font-size: 13px;"></span>
                <span class="fa fa-star checked" style="color: orange; font-size: 13px;"></span>
          ...
          <div class=" border border-2 mb-5 w-100 ">
            <img src="./img/val16.webp" alt="" srcset="">
            <div class="bg-white d-flex justify-content-between px-3 pt-3 ">
              <div>
                <span class="fa fa-star checked" style="color: orange; font-size: 13px;"></span>
                <span class="fa fa-star checked" style="color: orange; font-size: 13px;"></span>
        ...
        <swiper-slide >
            <div class=" border border-2 mb-5 w-100 ">
              <img src="./img/val1.webp" alt="" srcset="">
              <div class="bg-white d-flex justify-content-between px-3 pt-3 ">
                <div>
                  <span class="fa fa-star checked" style="color: orange; font-size: 13px;"></span>
                  <span class="fa fa-star checked" style="color: orange; font-size: 13px;"></span>
            ...
            <div class=" border border-2 mb-5 w-100 ">
              <img style="height: 15.4rem;" src="./img/val2.webp" alt="" srcset="">
              <div class="bg-white d-flex justify-content-between px-3 pt-3 ">
                <div>
                  <span class="fa fa-star checked" style="color: orange; font-size: 13px;"></span>
                  <span class="fa fa-star checked" style="color: orange; font-size: 13px;"></span>
            ...
            <div class=" border border-2 mb-5 w-100 ">
              <img style="height: 15.4rem;" src="./img/val3.webp" alt="" srcset="">
              <div class="bg-white d-flex justify-content-between px-3 pt-3 ">
                <div>
                  <span class="fa fa-star checked" style="color: orange; font-size: 13px;"></span>
                  <span class="fa fa-star checked" style="color: orange; font-size: 13px;"></span>
            ...
            <div class=" border border-2 mb-5 w-100 ">
                <img style="height: 15.4rem;" src="./img/val4.webp" alt="" srcset="">
                <div class="bg-white d-flex justify-content-between px-3 pt-3 ">
                <div>
                  <span class="fa fa-star checked" style="color: orange; font-size: 13px;"></span>
                  <span class="fa fa-star checked" style="color: orange; font-size: 13px;"></span>
        ...
        <swiper-slide >
            <div class=" border border-2 mb-5 w-100 ">
                <img style="height: 15.4rem;" src="./img/val5.webp" alt="" srcset="">
                <div class="bg-white d-flex justify-content-between px-3 pt-3 ">
                <div>
                  <span class="fa fa-star checked" style="color: orange; font-size: 13px;"></span>
                  <span class="fa fa-star checked" style="color: orange; font-size: 13px;"></span>
            ...
            <div class=" border border-2 mb-5 w-100 ">
                <img style="height: 15.4rem;" src="./img/val6.webp" alt="" srcset="">
                <div class="bg-white d-flex justify-content-between px-3 pt-3 ">
                <div>
                  <span class="fa fa-star checked" style="color: orange; font-size: 13px;"></span>
                  <span class="fa fa-star checked" style="color: orange; font-size: 13px;"></span>
            ...
            <div class=" border border-2 mb-5 w-100 ">
                <img style="height: 15.4rem;" src="./img/val7.webp" alt="" srcset="">
            ...
            <div class=" border border-2 mb-5 w-100 ">
                <img style="height: 15.4rem;" src="./img/val8.webp" alt="" srcset="">
        ...
        <swiper-slide >
            <div class=" border border-2 mb-5 w-100 ">
                <img style="height: 15.4rem;" src="./img/val9.webp" alt="" srcset="">
                <div class="bg-white d-flex justify-content-between px-3 pt-3 ">
                <div>
                  <span class="fa fa-star checked" style="color: orange; font-size: 13px;"></span>
                  <span class="fa fa-star checked" style="color: orange; font-size: 13px;"></span>
            ...
            <div class=" border border-2 mb-5 w-100 ">
                <img style="height: 15.4rem;" src="./img/val10.webp" alt="" srcset="">
            ...
            <div class=" border border-2 mb-5 w-100 ">
                <img style="height: 15.4rem;" src="./img/val11.webp" alt="" srcset="">
            ...
            <div class=" border border-2 mb-5 w-100 ">
                <img style="height: 15.4rem;" src="./img/val12.webp" alt="" srcset="">
