...
<head>
  ...
  <title>LA'FLEUR DECOR/Office Day</title>
...
<nav>
              ...
              <ul class="navbar-nav me-auto mb-2 mb-lg-0 ">
                ...
                <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li><a class="dropdown-item  active text-danger" href="./office.php">Office Flowers</a></li>
                    <li>
  ...
  <div class="about">
    <div class="container-fluid ">
      <div class="us">
        <h1 class="us2 border-bottom text-center"><span class="office"> Office Flower</span></h1>
      </div>
    </div>
  </div>
  <!-- about us write -->
  ...
  <footer style="background-color: rgba(255, 255, 255, 0.664)">
    <div class="container-fluid">
