          ...
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse " id="navbarSupportedContent">
              <ul class="navbar-nav me-auto mb-2 mb-lg-0 ">
                ...
                <li class="nav-item dropdown">
                  <a class="anchor mx-2 nav-link active text-danger " href="comparison.php" role="button" aria-expanded="false">
                    Comparison
                  </a>
...
<div class="container-fluid bg-white">
    <h1 class="pt-5 px-5 border-bottom">Comparison In  Different Categories</h1>
    <div class="container">
        <div class="container py-5">
            <!-- Aniversary flowers -->
            <h3 class="fw-bold" style=" color: rgb(253, 109, 133); letter-spacing: 2px;">Aniversary Special:</h3>
            <hr>
           ...
           <div class="col-sm-3">
            <div class=" border border-2 mb-5 w-100 ">
                <img class="w-100" src="./img/f9.webp" alt="" srcset="">
           ...
           <div class="col-sm-3">
            <div class=" border border-2 mb-5 w-100 ">
                <img class="w-100" src="./img/f6.webp" alt="" srcset="">
                <div class="bg-white d-flex justify-content-between px-3 pt-3 ">
                  <div>
                    <span class="fa fa-star checked" style="color: orange; font-size: 13px;"></span>
                    <span class="fa fa-star checked" style="color: orange; font-size: 13px;"></span>
           ...
           <div class="col-sm-3">
            <div class=" border border-2 mb-5 w-100 ">
                <img class="w-100" src="./img/f7.webp" alt="" srcset="">
                <div class="bg-white d-flex justify-content-between px-3 pt-3 ">
                  <div>
                    <span class="fa fa-star checked" style="color: orange; font-size: 13px;"></span>
                    <span class="fa fa-star checked" style="color: orange; font-size: 13px;"></span>
           ...
           <div class="col-sm-3">
            <div class=" border border-2 mb-5 w-100 ">
                <img class="w-100" src="./img/f8.webp" alt="" srcset="">
                <div class="bg-white d-flex justify-content-between px-3 pt-3 ">
                  <div>
                    <span class="fa fa-star checked" style="color: orange; font-size: 13px;"></span>
                    <span class="fa fa-star checked" style="color: orange; font-size: 13px;"></span>
           ...
           <div class="col-sm-3">
            <div class=" border border-2 mb-5 w-100 ">
                <img class="w-100" src="./img/f1.jpg" alt="" srcset="">
                <div class="bg-white d-flex justify-content-between px-3 pt-3 ">
                  <div>
                    <span class="fa fa-star checked" style="color: orange; font-size: 13px;"></span>
                    <span class="fa fa-star checked" style="color: orange; font-size: 13px;"></span>
           ...
           <div class="col-sm-3">
            <div class=" border border-2 mb-5 w-100 ">
                <img class="w-100" src="./img/f2.jpg" alt="" srcset="">
                <div class="bg-white d-flex justify-content-between px-3 pt-3 ">
                  <div>
                    <span class="fa fa-star checked" style="color: orange; font-size: 13px;"></span>
                    <span class="fa fa-star checked" style="color: orange; font-size: 13px;"></span>
           ...
           <div class="col-sm-3">
            <div class=" border border-2 mb-5 w-100 ">
                <img class="w-100" src="./img/f3.jpg" alt="" srcset="">
                <div class="bg-white d-flex justify-content-between px-3 pt-3 ">
                  <div>
                    <span class="fa fa-star checked" style="color: orange; font-size: 13px;"></span>
                    <span class="fa fa-star checked" style="color: orange; font-size: 13px;"></span>
           ...
           <div class="col-sm-3">
            <div class=" border border-2 mb-5 w-100 ">
                <img class="w-100" src="./img/f5.jpg" alt="" srcset="">
                <div class="bg-white d-flex justify-content-between px-3 pt-3 ">
                  <div>
                    <span class="fa fa-star checked" style="color: orange; font-size: 13px;"></span>
                    <span class="fa fa-star checked" style="color: orange; font-size: 13px;"></span>
            ...
            <h3 class="fw-bold" style=" color: rgb(253, 109, 133); letter-spacing: 2px;">Birthday Special:</h3>
            <hr>
           ...
           <div class="col-sm-3">
            <div class=" border border-2 mb-5 w-100 ">
                <img class="w-100" src="./img/f10.webp" alt="" srcset="">
                <div class="bg-white d-flex justify-content-between px-3 pt-3 ">
                  <div>
                    <span class="fa fa-star checked" style="color: orange; font-size: 13px;"></span>
                    <span class="fa fa-star checked" style="color: orange; font-size: 13px;"></span>
           ...
           <div class="col-sm-3">
            <div class=" border border-2 mb-5 w-100 ">
                <img class="w-100" src="./img/f11.webp" alt="" srcset="">
                <div class="bg-white d-flex justify-content-between px-3 pt-3 ">
                  <div>
                    <span class="fa fa-star checked" style="color: orange; font-size: 13px;"></span>
                    <span class="fa fa-star checked" style="color: orange; font-size: 13px;"></span>
           ...
           <div class="col-sm-3">
            <div class=" border border-2 mb-5 w-100 ">
                <img class="w-100" src="./img/f12.webp" alt="" srcset="">
                <div class="bg-white d-flex justify-content-between px-3 pt-3 ">
                  <div>
                    <span class="fa fa-star checked" style="color: orange; font-size: 13px;"></span>
                    <span class="fa fa-star checked" style="color: orange; font-size: 13px;"></span>
           ...
           <div class="col-sm-3">
            <div class=" border border-2 mb-5 w-100 ">
                <img class="w-100" src="./img/f13.webp" alt="" srcset="">
                <div class="bg-white d-flex justify-content-between px-3 pt-3 ">
                  <div>
                    <span class="fa fa-star checked" style="color: orange; font-size: 13px;"></span>
                    <span class="fa fa-star checked" style="color: orange; font-size: 13px;"></span>
           ...
           <div class="col-sm-3">
            <div class=" border border-2 mb-5 w-100 ">
                <img class="w-100" src="./img/f14.webp" alt="" srcset="">
                <div class="bg-white d-flex justify-content-between px-3 pt-3 ">
                  <div>
                    <span class="fa fa-star checked" style="color: orange; font-size: 13px;"></span>
                    <span class="fa fa-star checked" style="color: orange; font-size: 13px;"></span>
           ...
           <div class="col-sm-3">
            <div class=" border border-2 mb-5 w-100 ">
                <img class="w-100" src="./img/f15.webp" alt="" srcset="">
                <div class="bg-white d-flex justify-content-between px-3 pt-3 ">
                  <div>
                    <span class="fa fa-star checked" style="color: orange; font-size: 13px;"></span>
                    <span class="fa fa-star checked" style="color: orange; font-size: 13px;"></span>
           ...
           <div class="col-sm-3">
            ...
            <!-- birthday flowers -->
            <!-- Valentine flowers -->
            <h3 class="fw-bold" style=" color: rgb(253, 109, 133); letter-spacing: 2px;">Valentine Special:</h3>
            <hr>    
            <div class="row mt-2">
           ...
           <div class="col-sm-3">
            ...
            <!-- Valentine flowers -->
            <!-- Wedding Flowers -->
            <h3 class="fw-bold" style=" color: rgb(253, 109, 133); letter-spacing: 2px;">Wedding Special:</h3>
            <hr> 
            <div class="row mt-2">
                
           <div class="col-sm-3">
            <div class=" border border-2 mb-5 w-100 ">
                <img class="w-100" src="./img/card2.jpg" alt="" srcset="">
                <div class="bg-white d-flex justify-content-between px-3 pt-3 ">
                  <div>
                    <span class="fa fa-star checked" style="color: orange; font-size: 13px;"></span>
                    <span class="fa fa-star checked" style="color: orange; font-size: 13px;"></span>
           ...
           <div class="col-sm-3">
            <div class=" border border-2 mb-5 w-100 ">
                <img class="w-100" src="./img/card3.jpg" alt="" srcset="">
                <div class="bg-white d-flex justify-content-between px-3 pt-3 ">
                  <div>
                    <span class="fa fa-star checked" style="color: orange; font-size: 13px;"></span>
                    <span class="fa fa-star checked" style="color: orange; font-size: 13px;"></span>
           ...
           <div class="col-sm-3">
            <div class=" border border-2 mb-5 w-100 ">
                <img class="w-100" src="./img/card4.jpg" alt="" srcset="">
                <div class="bg-white d-flex justify-content-between px-3 pt-3 ">
                  <div>
                    <span class="fa fa-star checked" style="color: orange; font-size: 13px;"></span>
                    <span class="fa fa-star checked" style="color: orange; font-size: 13px;"></span>
           ...
           <div class="col-sm-3">
            <div class=" border border-2 mb-5 w-100 ">
                <img class="w-100" src="./img/card5.jpg" alt="" srcset="">
                <div class="bg-white d-flex justify-content-between px-3 pt-3 ">
                  <div>
                    <span class="fa fa-star checked" style="color: orange; font-size: 13px;"></span>
                    <span class="fa fa-star checked" style="color: orange; font-size: 13px;"></span>
           ...
           <div class="col-sm-3">
            <div class=" border border-2 mb-5 w-100 ">
                <img class="w-100" src="./img/card6.jpg" alt="" srcset="">
                <div class="bg-white d-flex justify-content-between px-3 pt-3 ">
                  <div>
                    <span class="fa fa-star checked" style="color: orange; font-size: 13px;"></span>
                    <span class="fa fa-star checked" style="color: orange; font-size: 13px;"></span>
           ...
           <div class="col-sm-3">
            <div class=" border border-2 mb-5 w-100 ">
                <img class="w-100" src="./img/categories-1.jpg" alt="" srcset="">
                <div class="bg-white d-flex justify-content-between px-3 pt-3 ">
                  <div>
                    <span class="fa fa-star checked" style="color: orange; font-size: 13px;"></span>
                    <span class="fa fa-star checked" style="color: orange; font-size: 13px;"></span>
           ...
           <div class="col-sm-3">
            <div class=" border border-2 mb-5 w-100 ">
                <img class="w-100" src="./img/categories-2.jpg" alt="" srcset="">
                <div class="bg-white d-flex justify-content-between px-3 pt-3 ">
                  <div>
                    <span class="fa fa-star checked" style="color: orange; font-size: 13px;"></span>
                    <span class="fa fa-star checked" style="color: orange; font-size: 13px;"></span>
           ...
           <div class="col-sm-3">
            <div class=" border border-2 mb-5 w-100 ">
                <img class="w-100" src="./img/categories-3 (1).jpg" alt="" srcset="">
                <div class="bg-white d-flex justify-content-between px-3 pt-3 ">
                  <div>
                    <span class="fa fa-star checked" style="color: orange; font-size: 13px;"></span>
                    <span class="fa fa-star checked" style="color: orange; font-size: 13px;"></span>
            ...
            <!-- Wedding Flowers -->
            <!-- Office flowers -->
            <h3 class="fw-bold" style=" color: rgb(253, 109, 133); letter-spacing: 2px;">Office Special:</h3>
            <hr>            
            <div class="row mt-2">
           ...
           <div class="col-sm-3">
            ...
            <!-- Office flowers -->
            <!-- party flowers -->
            <h3 class="fw-bold" style=" color: rgb(253, 109, 133); letter-spacing: 2px;">party Special:</h3>
            <hr> 
            <div class="row mt-2">
