...
<html lang="en">
    <head>
        ...
        <title>LA'FLEUR DECOR/Anniversary</title>
        ...
        <link rel="stylesheet" href="Aniversary.css">
...
<nav>
  ...
  <?php endif; ?>
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse " id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0 ">
              <li class="nav-item">
                <a class="anchor nav-link" aria-current="page" href="./home.php">Home</a>
              </li>
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li><a class="dropdown-item  active text-danger " href="./anniversary.php">anniversary Flowers</a></li>
   ...
   <div class="about">
    <div class="container-fluid ">
      <div class="us">
        <h1 class="us2 border-bottom text-center"><span class="Aniversary"> Aniversary Flower</span></h1>
      </div>
    </div>
</div>
<!-- about us write -->
    ...
    <div class="row mt-5">
      ...
      <swiper-container class="mySwiper pb-5" init="false">
        ...
        <swiper-slide >
            ...
            <div class=" border border-2 mb-5 w-100 ">
              <img style="height: 15.4rem;" src="./img/f6.webp" alt="" srcset="">
              <div class="bg-white d-flex justify-content-between px-3 pt-3 ">
                <div>
                  <span class="fa fa-star checked" style="color: orange; font-size: 13px;"></span>
                  <span class="fa fa-star checked" style="color: orange; font-size: 13px;"></span>
            ...
            <div class=" border border-2 mb-5 w-100 ">
              <img style="height: 15.4rem;" src="./img/f7.webp" alt="" srcset="">
              <div class="bg-white d-flex justify-content-between px-3 pt-3 ">
                <div>
                  <span class="fa fa-star checked" style="color: orange; font-size: 13px;"></span>
                  <span class="fa fa-star checked" style="color: orange; font-size: 13px;"></span>
            ...
            <div class=" border border-2 mb-5 w-100 ">
                <img style="height: 15.4rem;" src="./img/f8.webp" alt="" srcset="">
                <div class="bg-white d-flex justify-content-between px-3 pt-3 ">
                <div>
                  <span class="fa fa-star checked" style="color: orange; font-size: 13px;"></span>
                  <span class="fa fa-star checked" style="color: orange; font-size: 13px;"></span>
        ...
        <swiper-slide >
            <div class=" border border-2 mb-5 w-100 ">
                <img style="height: 15.4rem;" src="./img/f12.webp" alt="" srcset="">
                <div class="bg-white d-flex justify-content-between px-3 pt-3 ">
                <div>
                  <span class="fa fa-star checked" style="color: orange; font-size: 13px;"></span>
                  <span class="fa fa-star checked" style="color: orange; font-size: 13px;"></span>
            ...
            <div class=" border border-2 mb-5 w-100 ">
                <img style="height: 15.4rem;" src="./img/f9.webp" alt="" srcset="">
                <div class="bg-white d-flex justify-content-between px-3 pt-3 ">
                <div>
                  <span class="fa fa-star checked" style="color: orange; font-size: 13px;"></span>
                  <span class="fa fa-star checked" style="color: orange; font-size: 13px;"></span>
            ...
            <div class=" border border-2 mb-5 w-100 ">
                <img style="height: 15.4rem;" src="./img/f10.webp" alt="" srcset="">
            ...
            <div class=" border border-2 mb-5 w-100 ">
                <img style="height: 15.4rem;" src="./img/f11.webp" alt="" srcset="">
        ...
        <swiper-slide >
            <div class=" border border-2 mb-5 w-100 ">
                <img style="height: 15.4rem;" src="./img/f13.webp" alt="" srcset="">
                <div class="bg-white d-flex justify-content-between px-3 pt-3 ">
                <div>
                  <span class="fa fa-star checked" style="color: orange; font-size: 13px;"></span>
                  <span class="fa fa-star checked" style="color: orange; font-size: 13px;"></span>
            ...
            <div class=" border border-2 mb-5 w-100 ">
                <img style="height: 15.4rem;" src="./img/f14.webp" alt="" srcset="">
            ...
            <div class=" border border-2 mb-5 w-100 ">
                <img style="height: 15.4rem;" src="./img/f15.webp" alt="" srcset="">
