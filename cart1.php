...
<nav>
  ...
  <?php endif; ?>
          ...
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse " id="navbarSupportedContent">
              <ul class="navbar-nav me-auto mb-2 mb-lg-0 ">
                <li class="nav-item">
                  <a class="anchor nav-link s" aria-current="page" href="./index.php">Home</a>
                </li>
    ...
    <div class="container border my-5">
        <div class="row py-5">
            <div class="col-sm-6">
                <img class="w-100 flower" src="./img/f1.jpg" alt="">
            </div>
            <div class="col-sm-6">
                <h4 class="fw-bold">Mummy Flower</h4>
                <p class="text-secondary">SKU: 101</p>
                <div>
                  ...
                  <p class="fs-3 pt-3 fw-bold" style="color: rgb(247, 84, 111);">$22.62</p>
                  ...
                  <button type="submit"  class="btn btn-danger w-50 m-4">
                    ADD TO CART
                  </button>
                </form>
                  <div class="mt-3">
