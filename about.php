...
<nav>
  ...
  <?php endif; ?>
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse " id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0 ">
              ...
              <li class="nav-item dropdown">
                <a class="anchor mx-2 nav-link active text-danger " href="about.php" role="button" aria-expanded="false">
                  About Us
                </a>
    ...
    <!-- background picture -->
    <!-- cat and our greating special Moments --><!-- Our team members -->
    <div class="container-fluid bg-white">
        <!-- cat and our greating special Moments -->
        <h1 class="text-center py-5">About us</h1>
        <div class="container-fluid">
            <div class="row pb-5 mb-5">
                <div class="col-sm-6 ">
                    <img class="w-100 cat" src="./img/cat.avif" alt="">
                </div>
                <div class="col-sm-6 ">
                    <p class="text-secondary pt-3">WHO WE ARE</p>
                    <h1>
                        Creating Special Moments of Connection
                    </h1>
                    <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Inventore, ipsum repellendus deleniti,
                        qui ducimus rem laudaque.
                        <br><br>
                        Lorem ipsum dolor, sit amet consectetur adipisicing elit. Officiis repellendus, officia
                        cupiditate illo quae quiselectus ad nam exercitationem.
                    </p>
                    <button class="btn px-4 mt-4 rounded-pill" style="background-color: rgba(255, 192, 203, 0.404);">GET
                        IN TOUCH</button>
                </div>
            </div>
            <!-- cat and our greating special Moments -->
            <!-- our story and office picture -->
            <div class="row py-5 my-5">
                <div class="col-sm-6 ">
                    <p class="bg-dark text-white d-inline-block p-2 mt-3">OUR STORY</p>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nisi, voluptates? Deserunt animi,
                        assumenda provident repellendus magnam blanditiis error. Sed veritatis ad velit asperiores
                        facilis, aliquid vel cupiditate libero totam doloribus cumque repellat nulla eligendi,
                        quibusdam temporibus nihil doloremque eveniet. Totam velit necessitatibus sapiente? Odit,
                        quidem suscipit totam officiis labore exercitationem recusandae explicabo expedita ullam
                        aspernatur, in soluta sint dolores blanditiis voluptates consectetur pariatur id inventore
                        quo. Ducimus, deserunt tenetur sequi optio quisquam perspiciatis fugiat quis doloremque quas
                        dignissimos at dicta tempor</p>
                </div>
                <div class="col-sm-6 ">
                    <img class="w-100 office" src="./img/cms-img.jpg" alt="">
                </div>
            </div>
            <!-- our story and office picture -->
        </div>
        ...
        <div class="container  py-5">
            ...
            <div class="row d-flex justify-content-around">
                <div class="col-md-4">
                    <img class="w-100" style="height: 87%;" src="./img/afnan.jpg" alt="" srcset="">
                    <h4 class="text-danger pt-3 text-center"><strong> Syed Afnan Ali</strong></h4>
                    <p class="text-center text-secondary">OwnerShip & Ceo</p>
                </div>
                <div class="col-4">
                    <img class="w-100" style="height:  87%;" src="./img/hamza.jpg" alt="" srcset="">
                    <h4 class="text-danger pt-3 text-center"><strong> Syed Hamza aziz</strong></h4>
                    <p class="text-center text-secondary">Manager & Decor</p>
                </div>
                <div class="col-4">
                    <img class="w-100" style="height:  87%;" src="./img/shahmeer.jpg" alt="" srcset="">
                    <h4 class="text-danger pt-3 text-center"><strong>Syed M.shahmeer</strong></h4>
                    <p class="text-center text-secondary">Manager & Decor</p>
                </div>
            </div>
